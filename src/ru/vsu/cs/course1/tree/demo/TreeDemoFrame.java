    ...
    public TreeDemoFrame() {
        ...
        buttonInOrderTraverse.addActionListener(actionEvent -> {
            showSystemOut(() -> {
                ...
                for (Double i : BinaryTreeAlgorithms.inOrderValues(tree.getRoot())) {
        ...
        buttonPostOrderTraverse.addActionListener(actionEvent -> {
            showSystemOut(() -> {
                ...
                System.out.println();
                System.out.println("Итератор:");
                for (Double i : BinaryTreeAlgorithms.postOrderValues(tree.getRoot())) {
                    System.out.println(i);
                }
            });
        });
        buttonByLevelTraverse.addActionListener(actionEvent -> {
            showSystemOut(() -> {
                ...
                System.out.println();
                System.out.println("Итератор:");
                for (Double i : BinaryTreeAlgorithms.byLevelValues(tree.getRoot())) {
                    System.out.println(i);
                }
            });
        });
